    ...
    return (
        <div id="wd-lab1">
            ...
            <div id="wd-h-tag">
                ...
                to introduce topics such as HTML Documents, HTML Tags, Heading Tags, etc. 
        ...
        <div id="wd-lists">
            ...
            <ol id="wd-your-favorite-recipe">
                ...
                <li>Heat the pan</li>
                <li>Add seasoning to the butter</li>
                <li>Add Eggs to the pan</li>
                <li>Stir gently till cooked</li>
                <li>Serve and enjoy!!</li>
            </ol>
        </div>
        ...
        <div id="wd-images">
            ...
            <br />
            <img id="wd-teslabot" src="images/TeslaModelX.png" height="200px" />
        </div>
